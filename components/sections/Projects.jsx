        ...
        {selectedProject && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
            ...
            <motion.div
              ...
              className="relative w-full max-w-2xl max-h-[90vh] bg-white dark:bg-navy-card rounded-3xl border border-slate-200 dark:border-navy-border shadow-2xl overflow-y-auto z-10 my-auto p-6 sm:p-8"
            >
              {/* Close Button */}
              <button
                onClick={() => setSelectedProject(null)}
                aria-label="Close project modal"
                className="absolute top-5 right-5 p-2 rounded-full bg-slate-100 dark:bg-navy-light text-slate-600 dark:text-slate-300 hover:text-violet-accent dark:hover:text-electric-blue hover:bg-slate-200 dark:hover:bg-navy-border transition-colors cursor-pointer z-20"
              >
              ...
              {/* Title */}
              <h3 className="text-2xl sm:text-3xl font-extrabold font-poppins text-slate-900 dark:text-white mb-4">
              ...
              <div className="mb-8">
                ...
                <div className="flex flex-wrap gap-2">
                  {selectedProject.techStack.map((tech) => (
                    <span
                      key={tech}
                      className="px-3 py-1 rounded-lg text-xs font-medium bg-slate-100 dark:bg-navy-light text-slate-800 dark:text-slate-200 border border-slate-200/80 dark:border-navy-border"
                    >
                      {tech}
                    </span>
                  ))}
              ...
              <div className="pt-4 border-t border-slate-200 dark:border-navy-border/60 flex flex-wrap items-center justify-end gap-3">
                <a
                  href={selectedProject.githubUrl}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl border border-slate-300 dark:border-navy-border bg-white dark:bg-navy-card text-slate-700 dark:text-slate-200 hover:text-violet-accent dark:hover:text-electric-blue font-medium text-xs sm:text-sm transition-colors cursor-pointer"
                >
                  <FiGithub className="w-4 h-4" />
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-gradient-to-r from-violet-accent to-electric-blue text-white font-medium text-xs sm:text-sm shadow-md shadow-violet-accent/25 hover:shadow-electric-blue/30 transition-all cursor-pointer"
                >
