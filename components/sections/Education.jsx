  ...
  return (
    ...
    >
      ...
      <div className="max-w-4xl mx-auto">
        ...
        {/* Timeline-Aligned Education Card */}
        <div className="relative">
          {/* Milestone Connected Dot Pulse Node */}
          <div className="flex items-center justify-center mb-6">
            <div className="relative flex items-center justify-center">
              <motion.div
                ...
                className="z-20 flex items-center justify-center w-10 h-10 rounded-full bg-white dark:bg-navy-card border-2 transition-colors duration-300"
              >
                <div className="w-4 h-4 rounded-full bg-gradient-to-tr from-violet-accent to-electric-blue animate-pulse" />
              </motion.div>
            </div>
          </div>
