    ...
    >
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="relative">
          ...
          <div className="absolute top-0 bottom-0 left-4 md:left-1/2 w-0.5 -translate-x-1/2 bg-gradient-to-b from-violet-accent via-electric-blue to-purple-600/40 rounded-full" />
              ...
              return (
                ...
                >
                  ...
                  <motion.div
                    ...
                    className="absolute left-4 md:left-1/2 -translate-x-1/2 z-20 flex items-center justify-center w-9 h-9 sm:w-11 sm:h-11 rounded-full bg-white dark:bg-navy-card border-2 border-violet-accent dark:border-electric-blue shadow-lg shadow-violet-accent/20 dark:shadow-electric-blue/20"
                  >
                    <div className="w-3.5 h-3.5 sm:w-4 sm:h-4 rounded-full bg-gradient-to-tr from-violet-accent to-electric-blue animate-pulse" />
                  </motion.div>
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="flex flex-wrap items-center justify-between gap-2 mb-3">
                        ...
                        <div className="flex items-center gap-1.5 text-xs font-medium text-slate-500 dark:text-slate-400 bg-slate-100 dark:bg-navy-light px-3 py-1 rounded-full">
